...
const CORE_EVENT_TYPES: NotificationEventType[] = [
  { key: 'request_new', labelKey: 'admin.notifications.event.request_new', color: 0xf59e0b },
  { key: 'request_approved', labelKey: 'admin.notifications.event.request_approved', color: 0x6366f1 },
  { key: 'request_declined', labelKey: 'admin.notifications.event.request_declined', color: 0xef4444 },
  { key: 'media_available', labelKey: 'admin.notifications.event.media_available', color: 0x10b981 },
  { key: 'incident_banner', labelKey: 'admin.notifications.event.incident_banner', color: 0xef4444 },
];
